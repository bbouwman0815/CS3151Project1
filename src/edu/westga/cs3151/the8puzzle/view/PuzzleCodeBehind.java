...
public class PuzzleCodeBehind {
	...
	/**
	 * Creates a 3x3 button grid to represent the tiles of the 8-puzzle board
	 * and adds a listener for each button
	 */
	...
	/**
	 * Binds the solved-board property of this CodeBehind and the ViewModel
	 */
